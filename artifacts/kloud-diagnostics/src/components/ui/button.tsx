...
export function Button({ className, variant = 'primary', size = 'md', ...props }: ButtonProps) {
  ...
  const variants = {
    primary: "bg-primary text-primary-foreground hover:bg-[#7A0C1E] shadow-[0_4px_14px_rgba(200,16,46,0.28)] hover:shadow-[0_6px_20px_rgba(200,16,46,0.38)] hover:scale-[1.03]",
